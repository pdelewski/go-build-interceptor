...
function generateHooksCode(functionNames, moduleName = '') {
    ...
    // Note: HookContext is a local interface that matches the trampoline's implementation
...
// ============================================================================
// HookContext Interface (local interface matching the trampoline implementation)
// ============================================================================
// This interface is used by the hook implementations. It matches the
// HookContextImpl generated by the trampolines.
